...
Milestone M2. Implements the round timer and lockstep (spec #9-#12), the city
order queue and its two rotations (#4, #5, #12), the import/export/winner cycle
with all three fallback paths (#15-#19), the import repetition rule (#14) and
blind-voting data handling (#18, #21).
...
__all__ = ["GameEngine", "Config", "Content", "GameError", "LOCKSTEP_OPS"]
